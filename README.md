...
| [![](img/QIF101.png?raw=true)](http://qifstandards.org/)   | **QIF 101：掌握QIF基礎知識**  <br> 首先，必須了解ANSI/DMSC品量資訊基磐（QIF）操作性相通標準的基礎。 DMSC總裁Curtis Brown探討什麼是QIF，其重要性以及如何推升模型根基企業（MBE）。 <br>  [點擊觀看網絡研討會](https://youtu.be/3vsDCkxfIZg?DMSC=QIFTutorials)  <br> [下載QIF 101演示文稿](https://qifstandards.org/wp-content/uploads/2014/08/QIF-Webinar-PDF-Combined.pdf) |
